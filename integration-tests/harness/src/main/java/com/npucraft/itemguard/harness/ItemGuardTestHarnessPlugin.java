...
public final class ItemGuardTestHarnessPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        if (Bukkit.getPluginManager().getPlugin("HuskSync") != null) {
            try {
                Class<?> observer = Class.forName("com.npucraft.itemguard.harness.HuskSyncEventObserver");
                ...
                try {
                    Class<?> admin = Class.forName("com.npucraft.itemguard.harness.HuskSyncAdmin");
