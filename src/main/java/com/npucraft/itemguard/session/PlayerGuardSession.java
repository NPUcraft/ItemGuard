...
import com.npucraft.itemguard.flow.AttributionDecision;
...
public final class PlayerGuardSession {
    ...
    private boolean attributionGraceUsed;
    private AttributionDecision lastAttribution;
    private List<RiskIncidentSnapshot> activeIncidents = List.of();
    ...
    public boolean attributionGraceUsed() {
        return attributionGraceUsed;
    }

    public void setAttributionGraceUsed(boolean attributionGraceUsed) {
        this.attributionGraceUsed = attributionGraceUsed;
    }

    public AttributionDecision lastAttribution() {
        return lastAttribution;
    }

    public void setLastAttribution(AttributionDecision lastAttribution) {
        this.lastAttribution = lastAttribution;
    }

    public List<RiskIncidentSnapshot> activeIncidents() {
        return activeIncidents;
    }

    public void setActiveIncidents(List<RiskIncidentSnapshot> activeIncidents) {
        this.activeIncidents = activeIncidents == null ? List.of() : List.copyOf(activeIncidents);
    }
}
