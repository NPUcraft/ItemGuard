...
public final class InventoryInteractionListener implements Listener {
    ...
    public void onClick(InventoryClickEvent event) {
        ...
        try {
            ...
            if (!topIsPlayer && (clickedTop || action == InventoryAction.MOVE_TO_OTHER_INVENTORY && clickedTop)) {
                hintFromContainer(player, top, current, action, interaction);
    ...
    private void hintFromContainer(Player player, Inventory top, ItemStack current, InventoryAction action, UUID interaction) {
    ...
    private static FlowSource sourceForResult(InventoryType type) {
        return switch (type) {
            ...
            case ANVIL, GRINDSTONE, STONECUTTER, LOOM, CARTOGRAPHY, SMITHING -> FlowSource.CRAFTING;
